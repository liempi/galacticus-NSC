...
!!}
  ...
  !![
  <blackHoleSeeds name="blackHoleSeedsMulti" docformat="rst">
  ...
  interface blackHoleSeedsMulti
     !!{RST
     Constructor for the  :galacticus-class:`blackHoleMulti` black hole seed class.
     !!}
...
contains
  ...
  function blackHoleMultiConstructorParameters(parameters) result(self)
    !!{RST
     Constructor for the :galacticus-class:`blackHoleMulti` black hole seed class. which takes a parameter set as input.
    !!}
  ...
  function blackHoleMultiConstructorInternal(blackHoleSeeds) result(self)
    !!{RST
    Internal constructor for the :galacticus-class:`blackHoleMulti` seed class.
    !!}
    implicit none
    type (blackHoleSeedsMulti)                         :: self
  ...
  subroutine blackHoleMultiDestructor(self)
    !!{RST
    Destructor for the :galacticus-class:`blackHoleMulti` seed class.
    !!}
    implicit none
