...
module Globular_Cluster_Infall_Rates_Disks
  !!{
  Provides a class that implements calculations of rates of disk globular clusters infalling into nuclear star clusters.
  !!}
...
end module Globular_Cluster_Infall_Rates_Disks
