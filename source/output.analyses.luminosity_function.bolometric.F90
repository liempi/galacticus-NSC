...
!!}
  ...
  !!]
  type, extends(outputAnalysisVolumeFunction1D) :: outputAnalysisBlackHoleLuminosityFunction
     !!{
  ...
  interface outputAnalysisBlackHoleLuminosityFunction
     !!{
     Constructors for the ``luminosityFunctionBlackHole'' output analysis class.
     !!}
     module procedure luminosityFunctionBlackHoleConstructorParameters
     module procedure luminosityFunctionBlackHoleConstructorInternal
     module procedure luminosityFunctionBlackHoleConstructorFile
  end interface outputAnalysisBlackHoleLuminosityFunction

contains

  function luminosityFunctionBlackHoleConstructorParameters(parameters) result (self)
    !!{
  ...
  function luminosityFunctionBlackHoleConstructorInternal(label,comment,luminosities,galacticFilter_,surveyGeometry_,cosmologyFunctions_,cosmologyFunctionsData,outputAnalysisPropertyOperator_,outputAnalysisDistributionOperator_,outputTimes_,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,targetLabel,functionValueTarget,functionCovarianceTarget) result(self)
    ...
    use :: Node_Property_Extractors                , only : nodePropertyExtractorAGNBolometricLuminosity
    ...
    type            (nodePropertyExtractorAGNBolometricLuminosity      )               , pointer                  :: nodePropertyExtractor_
    ...
    self%outputAnalysisVolumeFunction1D=                                                                                               &
         ...
         &                                'luminosityFunctionBlackHoleBolometric'//label                                             , &
         &                                comment                                                                                    , &
         &                                var_str('luminosity'                                                                      ), &
         &                                var_str('Black hole bolometric luminosity at the bin center'                              ), &
         &                                var_str('ergs/s'                                                                          ), &
         &                                ergs                                                                                       , &
         ...
         &                                var_str('$\mathrm{d}n/\mathrm{d}\log_\mathrm{10} L_{\mathrm{bol}}$ [$_\chi$Mpc$^{-3}$]'   ), &
         &                                .true.                                                                                     , &
         &                                .true.                                                                                     , &
         &                                targetLabel                                                                                , &
         &                                functionValueTarget                                                                        , &
    ...
    return
  end function luminosityFunctionBlackHoleConstructorInternal

  subroutine luminosityFunctionBlackHoleDestructor(self)
    !!{
    Destructor for  the ``luminosityFunctionBlackHole'' output analysis class.
    !!}
