...
!!}
  ...
  !!]
  type, extends(outputAnalysisBlackHoleLuminosityFunction) :: outputAnalysisLuminosityFunctionAkins2024CosmosWeb
     !!{
  ...
  interface outputAnalysisLuminosityFunctionAkins2024CosmosWeb
     !!{
     Constructors for the ``luminosityFunctionAkins2024CosmosWeb'' output analysis class.
     !!}
     module procedure luminosityFunctionAkins2024CosmosWebConstructorParameters
     module procedure luminosityFunctionAkins2024CosmosWebConstructorInternal
  end interface outputAnalysisLuminosityFunctionAkins2024CosmosWeb

contains

  function luminosityFunctionAkins2024CosmosWebConstructorParameters(parameters) result (self)
    !!{
  ...
  function luminosityFunctionAkins2024CosmosWebConstructorInternal(cosmologyFunctions_,gravitationalLensing_,outputTimes_,randomErrorMinimum,randomErrorMaximum,randomErrorPolynomialCoefficient,systematicErrorPolynomialCoefficient,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,sizeSourceLensing) result (self)
    ...
    !!]
    fileName='luminosityFunctionCosmosWeb2023_z5.00_7.00.hdf5'
    ...
    !!]
    ! Build the object.
    self%outputAnalysisBlackHoleLuminosityFunction=                                                                                          &
         & outputAnalysisBlackHoleLuminosityFunction(                                                                                        &
         &                                        var_str('Akins2024CosmosWeb'                                                            ), &
         &                                        var_str('Bolometric luminosity function for the Akins et al. (2024) Cosmos-Web analysis'), &
    ...
    return
  end function luminosityFunctionAkins2024CosmosWebConstructorInternal

  subroutine luminosityFunctionAkins2024CosmosWebDestructor(self)
    !!{
    Destructor for the ``luminosityFunctionAkins2024CosmosWeb'' output analysis class.
    !!}
    implicit none
    type(outputAnalysisLuminosityFunctionAkins2024CosmosWeb), intent(inout) :: self

    !![
    <objectDestructor name="self%gravitationalLensing_"/>
    !!]
    return
  end subroutine luminosityFunctionAkins2024CosmosWebDestructor
