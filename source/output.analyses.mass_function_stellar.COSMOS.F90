...
!!}
  ...
  !![
  <outputAnalysis name="outputAnalysisMassFunctionStellarCOSMOS">
   <description>
    An COSMOS stellar mass function output analysis class, for $5.0 &lt; z&lt; 7.0$ galaxies measured by .
  ...
  !!]
  type, extends(outputAnalysisMassFunctionStellar) :: outputAnalysisMassFunctionStellarCOSMOS
     !!{
     An COSMOS stellar mass function output analysis class.
     !!}
     private
     ...
     double precision                                                       :: randomErrorMinimum                        , randomErrorMaximum                  , &
          &                                                                    sizeSourceLensing
   contains
     final :: massFunctionStellarCOSMOSDestructor
  end type outputAnalysisMassFunctionStellarCOSMOS

  interface outputAnalysisMassFunctionStellarCOSMOS
     !!{
     Constructors for the ``massFunctionStellarCOSMOS'' output analysis class.
     !!}
     module procedure massFunctionStellarCOSMOSConstructorParameters
     module procedure massFunctionStellarCOSMOSConstructorInternal
  end interface outputAnalysisMassFunctionStellarCOSMOS

contains

  function massFunctionStellarCOSMOSConstructorParameters(parameters) result (self)
    !!{
    Constructor for the ``massFunctionStellarCOSMOS'' output analysis class which takes a parameter set as input.
    !!}
    use :: Input_Parameters, only : inputParameter, inputParameters
    implicit none
    type            (outputAnalysisMassFunctionStellarCOSMOS)                              :: self
    ...
    <inputParameter>
      ...
      <description>The minimum random error for COSMOS stellar masses.</description>
    </inputParameter>
    <inputParameter>
      ...
      <defaultValue>0.1d0</defaultValue>
      <description>The maximum random error for COSMOS stellar masses.</description>
    </inputParameter>
    <inputParameter>
      ...
      <defaultValue>[0.1d0]</defaultValue>
      <description>The coefficients of the random error polynomial for COSMOS stellar masses.</description>
    </inputParameter>
    <inputParameter>
      ...
      <description>The coefficients of the systematic error polynomial for COSMOS stellar masses.</description>
    </inputParameter>
    <inputParameter>
    ...
    <inputParameter>
      ...
      <description>The number of bins per decade of halo mass to use when constructing COSMOS stellar mass function covariance matrices for main branch galaxies.</description>
    </inputParameter>
    <inputParameter>
      ...
      <description>The minimum halo mass to consider when constructing COSMOS stellar mass function covariance matrices for main branch galaxies.</description>
    </inputParameter>
    <inputParameter>
      ...
      <description>The maximum halo mass to consider when constructing COSMOS stellar mass function covariance matrices for main branch galaxies.</description>
    </inputParameter>
    ...
    !!]
    ! Build the object.
    self=outputAnalysisMassFunctionStellarCOSMOS(cosmologyFunctions_,gravitationalLensing_,outputTimes_,randomErrorMinimum,randomErrorMaximum,randomErrorPolynomialCoefficient,systematicErrorPolynomialCoefficient,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,sizeSourceLensing)
    !![
  ...
  function massFunctionStellarCOSMOSConstructorInternal(cosmologyFunctions_,gravitationalLensing_,outputTimes_,randomErrorMinimum,randomErrorMaximum,randomErrorPolynomialCoefficient,systematicErrorPolynomialCoefficient,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,sizeSourceLensing) result (self)
    ...
    cosmologyParametersSimple     (                            &amp;
         &amp;                     OmegaMatter    = 0.31500d0, &amp;
         &amp;                     OmegaDarkEnergy= 0.68400d0, &amp;
         &amp;                     HubbleConstant =67.66000d0, &amp;
         &amp;                     temperatureCMB = 2.72548d0, &amp;
         &amp;                     OmegaBaryon    = 0.04900d0  &amp;
         &amp;                    )
     </constructor>
    </referenceConstruct>
    ...
    description=var_str('Stellar mass function for the Akins et al. (2024) COSMOS analysis, ')
    ...
    !!]
    ! Build the COSMOS survey geometry of Akins et al. (2024) with their imposed redshift limits.
    allocate(surveyGeometry_)
    !![
    <referenceConstruct object="surveyGeometry_" constructor="surveyGeometryFullSky(redshiftMinimum=5.0d0,redshiftMaximum=7.0d0,cosmologyFunctions_=cosmologyFunctions_)"/>
    !!]
    ...
    return
  end function massFunctionStellarCOSMOSConstructorInternal

  subroutine massFunctionStellarCOSMOSDestructor(self)
    !!{
    Destructor for the {\normalfont \ttfamily massFunctionStellarCOSMOS} output analysis class.
    !!}
    implicit none
    type(outputAnalysisMassFunctionStellarCOSMOS), intent(inout) :: self

    !![
    <objectDestructor name="self%gravitationalLensing_"/>
    !!]
    return
  end subroutine massFunctionStellarCOSMOSDestructor
