...
!!}
  ...
  <outputAnalysis name="outputAnalysisMassFunctionStellarCOSMOS">
   <description>
    An COSMOS stellar mass function output analysis class, for $0.2 &lt; z&lt; 4.0$ galaxies measured by \cite{muzzin_evolution_2013}.
...
contains
  ...
  function massFunctionStellarCOSMOSConstructorInternal(cosmologyFunctions_,gravitationalLensing_,outputTimes_,randomErrorMinimum,randomErrorMaximum,randomErrorPolynomialCoefficient,systematicErrorPolynomialCoefficient,covarianceBinomialBinsPerDecade,covarianceBinomialMassHaloMinimum,covarianceBinomialMassHaloMaximum,sizeSourceLensing) result (self)
    ...
    description=var_str('Stellar mass function for the Muzzin et al. (2013) COSMOS analysis, ')

    fileName     ='Stellar_Mass_Function_Cosmos_2023_z5.00_7.00.hdf5'
    massThreshold=1.0d9
    description  =description//"$z=5.0$--7.0$"
    ...
    !!]
    ! Build the COSMOS survey geometry of Muzzin et al. (2013) with their imposed redshift limits.
