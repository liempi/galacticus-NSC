...
!!    along with Galacticus.  If not, see <http://www.gnu.org/licenses/>.
  ...
  type, extends(nodePropertyExtractorTuple) :: nodePropertyExtractorBlackHoleSeedingVMS
     ...
     !!}
     private
     integer  :: radiusNuclearStarClustersID              , coreCollapseTimescaleNuclearStarClusterID, &
...
contains
  ...
  integer function blackHoleSeedingVMSElementCount(self,time)
    ...
    blackHoleSeedingVMSElementCount=5
    return
  ...
  function blackHoleSeedingVMSExtract(self,node,time,instance)
    ...
    allocate(blackHoleSeedingVMSExtract(5))
  ...
  subroutine blackHoleSeedingVMSNames(self,time,names)
    ...
    names(3)=var_str('nuclearStarClusterGasMass'              )
    names(4)=var_str('nuclearStarClusterStellarMass'          )
    names(5)=var_str('nuclearStarClusterCoreCollapseTimescale')
    return
  ...
  subroutine blackHoleSeedingVMSDescriptions(self,time,descriptions)
    ...
    descriptions(2)=var_str('Radius of the nuclear star cluster [Mpc].'                                              )
    descriptions(3)=var_str('Gaseous mass of the nuclear star cluster [M⊙].'                                         )
    descriptions(4)=var_str('Stellar mass of the nuclear star cluster [M⊙].'                                         )
    descriptions(5)=var_str('Core collapse timescale of the nuclear star cluster [Gyr].'                             )
    return
  ...
  function blackHoleSeedingVMSUnitsInSI(self,time)
    ...
    allocate(blackHoleSeedingVMSUnitsInSI(5))
