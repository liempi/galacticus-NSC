...
!!{
Implements a galactic high-pass filter for black hole mass.
!!}

  !![
  <galacticFilter name="galacticFilterBlackHoleMass">
   <description>
   A galactic high-pass filter for black hole mass. Galaxies with a black hole with mass greater than or equal
  ...
  interface galacticFilterBlackHoleMass
     !!{
     Constructors for the {\normalfont \ttfamily blackHoleMass} galactic filter class.
     !!}
...
contains
  ...
  function blackHoleMassConstructorParameters(parameters) result(self)
    !!{
    Constructor for the {\normalfont \ttfamily blackHoleMass} galactic filter class which takes a parameter set as input.
    !!}
    ...
    <inputParameter>
      ...
      <description>The parameter $M_0$ (in units of $M_\odot$) appearing in the stellar mass threshold for the black hole mass galactic filter class.</description>
    </inputParameter>
    !!]
  ...
  logical function blackHoleMassPasses(self,node)
    !!{
    ...
    double precision                                                     :: blackHoleMass

    blackHole           =>  node     %blackHole()
    blackHoleMass       =  +blackHole%mass     ()
    blackHoleMassPasses =   blackHoleMass         &
         &                >=                      &
         &                  self%massThreshold
    return
